...
class ArtefactsControllerTest < ActionController::TestCase
  ...
  test "should create artefact" do
    assert_difference('Artefact.count') do
      post :create, artefact: { content: @artefact.content, creator_id: @artefact.creator_id, name: @artefact.name }
    end
  ...
  test "should update artefact" do
    patch :update, id: @artefact, artefact: { content: @artefact.content, creator_id: @artefact.creator_id, name: @artefact.name }
    assert_redirected_to artefact_path(assigns(:artefact))
  end
